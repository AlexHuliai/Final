              ...
              <tbody>
                ...
                <tr>
                  ...
                  <div class="text-center">
                    ...
                    <a href="userprofile?user_id=${item.user_id}">
                    <img src="static/img/users/${item.user_id}/profile/${item.image}"
                  ...
                  <td>
                  <a href="userprofile?user_id=${item.user_id}" class="btn btn-link">${item.fname} ${item.lname}
                  </a>
                  </td>
                  <td>
                      ${item.email}
                  ...
                  <td>
                   ...
                   <td>
                  <a href="update?user_id=${item.user_id}" class="text-success"> <i class="icon-pencil"></i></a>
                  <a href="delete?user_id=${item.user_id}" onclick="confirmed(); return false;" > <i class="icon-trash"></i></a>
                   </td>
                  </c:if>
                </tr>
                </c:forEach>
