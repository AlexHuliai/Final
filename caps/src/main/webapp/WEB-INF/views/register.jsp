...
<form:form action="${action}" modelAttribute="user" method="post" class="form-horizontal">
  ...
  <form:errors path="password" class="text-error"/>
                  ...
                  <div class="control-group ${hidden}">
                    ...
                    <div class="controls">
                     <form:input type="password" path="pass2" placeholder="repeatepass" /> 
                    <div class="has-error">
  ...
  <form:errors path="lname" class="text-error"/>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            ...
            <div class="has-error">
                <form:errors path="zipcode" class="text-error"/>
            </div>
        </div>
                  ...
                  <div class="control-group">
                    ...
                    <div class="has-error">
  <form:errors path="telephone" class="text-error"/>
</div>
</div>
